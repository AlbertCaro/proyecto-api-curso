...
import { IsUserIdValidator } from 'src/infraestructure/user/validator/is-user-id.validator';
...
@Module({
  ...
  exports: [GetUserByEmail, UserRepository, GetUserById, IsUserIdValidator],
})
